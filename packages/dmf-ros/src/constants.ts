...
export const API_ENDPOINTS = {
   ...
   */
  GET_HOST: (accessKey: string) => `/hosts/${accessKey}/`,

  /**
   * Get all remotes for a host
   * @param accessKey - The access key to identify the host
   */
  GET_REMOTES: (accessKey: string) => `/hosts/${accessKey}/remotes`,
   ...
   */
  GET_REMOTE: (accessKey: string, key: string) =>
    `/hosts/${accessKey}/remote/${key}`,
} as const;